 ...
 * Only checks dist/main.js and dist/main.mjs; optional name lists are excluded.
 * Tree-shaking (names not in default-only consumer bundle) is verified by check-tree-shake.mjs in this folder.
 */
...
const MAX_MAIN_JS_BYTES = 380_000;
const MAX_MAIN_MJS_BYTES = 380_000;
